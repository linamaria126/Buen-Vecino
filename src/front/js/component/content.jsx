...
const Content = () => {
  return (
    <>
      <section className="py-20" id="quienes-somos">
        <div className="container mx-auto">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2">
            <div>
              <p className="font-body text-black-600">La plataforma que conecta residentes</p>
              <h2 className="text-3xl font-bold font-title text-black-600">Quiénes somos</h2>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-3">
            ...
            <div className="bg-[#E2F0DBFF] p-6 rounded-lg shadow-lg col-span-2 flex items-center pt-0">
              ...
              <Icon4 alt="Reserve spaces icon" className="w-25 h-15 fill-green-800" />

            </div>

            <div className="bg-[#F2FAFCFF] p-6 rounded-lg shadow-lg relative">
              <h3 className="text-xl font-bold font-title mb-2 relative z-10">Servicios de votación</h3>
              <p className="mb-4 font-body relative z-10">Buen vecino te ahorra gastos adicionales a tu Unidad residencial y permite el servicio de votación en Asambleas de Copropietarios.</p>
              <div className="absolute bottom-0 right-0 z-0 w-25 h-15">
                <Mundo2 alt="Voting services icon" className="fill-sky-300" />
              </div>
            </div>
      ...
      <section className="bg-[#5549AFFF] text-white py-20">
