        ...
        <div ClassName="container">
            <div className="grid lg:grid-cols-3 grid-rows-3 bg-[#9890D1FF] relative">
                ...
                <div className="m-auto text-center">
                    ...
                    <Link to={'/pages/Login'} button className="bg-white   lg:inline-block lg:mt-0 text-[#796FC3FF] hover:bg-[#796FC3FF] text-[#796FC3FF] font-body py-2 px-2 rounded-full md:mt-3 ms-5">
                        Registrate</Link>
                </div>
