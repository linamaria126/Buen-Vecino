        ...
        <div ClassName="container">
            <div className="grid lg:grid-cols-3 grid-rows-1 bg-[#9890D1FF] relative">
                ...
                <div className="col-start-3">
                    <img src={image1295} alt="1295" className="h-20 w-30 rounded-full bg-[#D6D3EDFF] mt-1" />
                </div>
                ...
                <div className=" relative flex justify-center items-center h-full">
                    <img src={image4} alt="4" className="h-40 w-40 rounded-full bg-[#E2F0DBFF] absolute" />
                ...
                <div className="relative">
                    <img src={image7} alt="7" className="h-20 w-30 rounded-full md:mt-0 s bg-[#E2F0DBFF] absolute right-0" />
