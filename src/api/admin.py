...
from .models import db, User, Unidad_residencial, Residentes, Apartamento, Vehiulos, Mascotas, Reservas, Publicaciones
...
def setup_admin(app):
    ...
    # admin.add_view(ModelView(Residentes, db.session)),
    # admin.add_view(ModelView(Apartamento, db.session)),
    # admin.add_view(ModelView(Vehiulos, db.session)),
